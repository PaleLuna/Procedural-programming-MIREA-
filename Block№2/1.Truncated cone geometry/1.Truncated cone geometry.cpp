...
{
	double volume = pi/3 * h * (pow(r1, 2) + r1 * r2 + pow(r2, 2));
	return volume;
}
...
int main()
{
	...
	printf("Вычисление объема и полной поверхности усеченного конуса\n\n");

	printf ("Введите радиус нижнего основания: ");
	r1 = GetVar("радиус нижнего основания");
	printf("Введите радиус верхнего основания: ");
	r2 = GetVar("радиус верхнего основания");
	printf("Введите высоту усечённого конуса: ");
	h = GetVar("высоту");
